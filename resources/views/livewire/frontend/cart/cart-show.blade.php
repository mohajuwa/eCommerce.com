        ...
        <div class="container">
                        ...
                        <div class="cart-item">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-7 my-auto">
                                    <div class="quantity">
                                        <div class="input-group">
                                            ...
                                            <input type="text" wire:loading.attr="disabled"
                                                value="{{$cartItem->quantity}}" class="input-quantity" />

                                            <button type="button" wire:click="incrementQuantity({{$cartItem->id}})"
                                ...
                                <div class="col-md-1 my-auto">
                                    ...
                                    @php
                                    $totalPrice += $cartItem->product->selling_price * $cartItem->quantity @endphp
                                </div>
            ...
            <div class="row">
                <div class="col-md-8 my-md-auto mt-3">
                    <h4>
                        Get the best deals & offers <a href="{{url('/collections')}}">shop now</a> </h4>
