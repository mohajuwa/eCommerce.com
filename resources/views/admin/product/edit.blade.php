                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="GetSubCategory" name="sub_category_id">
                                                ...
                                                @foreach ($getSubCategory as $subCatItem)
                                                    <option value="{{ $subCatItem->id }}"
                                                        {{ old('sub_category_id', $product->sub_category_id) == $subCatItem->id ? 'selected' : '' }}>
                                                        {{ $subCatItem->name }}
                                                    </option>
                                                @endforeach
                                                ...
                                                @foreach ($getColor as $colorItem)
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <input type="checkbox" {{ $checked }} name="color_id[]"
                                                            value="{{ $colorItem->id }}"
                                                            {{ is_array(old('color_id')) && in_array($colorItem->id, old('color_id')) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="image[]" class="form-control" multiple
                                                accept="image/*" style="padding: 5px;">
                                        ...
                                        @foreach ($product->getImage as $image)
                                            @if (!empty($image->getImage()))
                                                <div class="col-md-1 sortable_image" id="{{ $image->id }}"
                                                    ...
                                                    <img src="{{ $image->getImage() }}" class=" img-fluid"
                                                        alt="" style="width: 150px;max-height:150px;">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control " name="short_description" rows="3" placeholder="Enter Short Description">{{ old('short_description', $product->short_description) }}</textarea>
                                            <div style="color:red">{{ $errors->first('short_description') }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control editor" name="description" rows="5" placeholder="Enter Description ">{{ old('description', $product->description) }}</textarea>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control editor" name="shopping_returns" rows="3" placeholder="Enter Shopping Returns">{{ old('shopping_returns', $product->shopping_returns) }}</textarea>
